                        ...
                        <li class="dropdown user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow border-0 p-4 rounded-4">
                                <li class="mb-3">
                                    ...
                                    <a class="btn bg-dark text-white w-100" href="auth-signin.html"
            ...
            <div class="container-fluid">
                ...
                <div class="row g-3 row-deck">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-3 col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h3>$2315</h3>
                                <p class="text-muted">
                                    23% <i class="fa fa-level-up text-success"></i> Total Growth
                                </p>
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-3 col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h3>$1025</h3>
                                <p class="text-muted">
                                    52% <i class="fa fa-level-up text-success"></i> Bounce Rate
                                </p>
                    ...
                    <div class="col-xxl-6 col-xl-8 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title fw-normal m-0">Sales Reports</h5>
                            ...
                            <div class="card-body">
                                <small class="text-muted">Sales Performance for Online and Offline Reports</small>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4>6.25</h4>
                                <p class="mb-2">
                                    <span><i class="fa fa-caret-up text-success ml-1"></i>
                                        +1.12</span>
                                    vs last month (4.0)
                                </p>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title fw-normal m-0">Sales Revenue</h5>
                                <div class="card-action">
                                    <div class="dropdown">
                                        <a href="#" class="dropdown-toggle after-none gray-8"
                                            data-bs-toggle="dropdown" aria-expanded="false" title="Card Filter">
                            ...
                            <div class="card-body text-center">
                                <div id="apex_sales_revenue"></div>
                                <h3 class="mb-0 mt-3 font300">
                                    24,301 <span class="text-green font-15">+3.7%</span>
                                </h3>
                                <small>Lorem Ipsum is simply dummy text <br />
                                    <a href="#">Read more</a>
                                </small>
                            </div>
                        </div>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title fw-normal m-0">My Balance</h5>
                                <div class="card-action">
                                    <div class="dropdown">
                                        <a href="#" class="dropdown-toggle after-none gray-8"
                                            data-bs-toggle="dropdown" aria-expanded="false" title="Card Filter">
                            ...
                            <div class="card-footer d-flex align-items-center">
                                <div class="avatar bg-accent lg rounded-circle no-thumbnail">
                                    <i class="fa fa-building"></i>
                                </div>
                                <div class="ms-3">
                                    <span>Properties</span>
                                    <h5 class="mb-0">53,251</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title fw-normal m-0">Product Valuation</h5>
                                <div class="card-action">
                                    <div class="dropdown">
                                        <a href="#" class="card-options-remove text-danger"
                                            data-toggle="card-remove">
