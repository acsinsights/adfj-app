                            ...
                            <div class="chart-items">
                                <div class=" col-xl-12 col-sm-12">
                                    <div class="row text-black text-start mt-4 chart-link">
                                        ...
                                        <span class="mb-2 col-6">
                                            <svg class="me-1" width="19" height="19" viewbox="0 0 19 19"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card-body pb-0">
                            <div class="pb-3 border-bottom mb-3">
                                <div class="d-flex mb-3 flex-wrap align-items-end">
                                    <img class="rounded me-3" src="images/contacts/pic11.jpg" width="40"
                                        alt="">
                                    <div>
                            ...
                            <div class="pb-3 border-bottom mb-3">
                                <div class="d-flex mb-3 flex-wrap align-items-end">
                                    <img class="rounded me-3" src="images/contacts/pic22.jpg" width="40"
                                        alt="">
                                    <div>
                            ...
                            <div class="pb-3 border-bottom mb-3">
                                <div class="d-flex mb-3 flex-wrap align-items-end">
                                    <img class="rounded me-3" src="images/contacts/pic33.jpg" width="40"
                                        alt="">
                                    <div>
