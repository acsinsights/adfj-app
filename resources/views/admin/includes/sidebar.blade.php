    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html">
                  ...
                  {{-- <img src="{{ asset('user-assets/img/logo/adfj.svg') }}" class="header-brand-img desktop-lgo"
                    ...
                    viewBox="0 0 774.18 259.41" style="enable-background:new 0 0 774.18 259.41;height: 40px;" xml:space="preserve">
               <style type="text/css">
                   .st0{fill:#2EBBC4;}
                   .st1{fill:#EB1971;}
                   .st2{fill:#261A50;}
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('admin.allposts') }}"><i class="fa-solid fa-table-cells"></i><span class="menu-title text-truncate" data-i18n="Email">All Posts</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('admin.featuredposts') }}"><i class="fa-solid fa-folder"></i><span class="menu-title text-truncate" data-i18n="Chat">Featured Posts</span></a>
                </li>
                <li class="nav-item"><a class="d-flex align-items-center" href="{{ route('admin.addposts') }}"><i class="fa-solid fa-plus"></i><span class="menu-title text-truncate" data-i18n="Todo">Add Posts</span></a>

                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('admin.type') }}"><i class="fa-solid fa-plus"></i><span class="menu-title text-truncate" data-i18n="Calendar">Add Service Type</span></a>
                </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('admin.music') }}"><i class="fa-solid fa-music"></i><span class="menu-title text-truncate" data-i18n="Typography">Music</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('admin.video') }}"><i class="fa-solid fa-video"></i><span class="menu-title text-truncate" data-i18n="Colors">Video</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('admin.graphics') }}"><i class="fa-regular fa-images"></i><span class="menu-title text-truncate" data-i18n="Feather">Graphics</span></a>
                </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('admin.our-clientlele') }}"><i class="fa-solid fa-users"></i><span class="menu-title text-truncate" data-i18n="Typography">Client Logo</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('admin.testimonial') }}"><i class="fa-solid fa-star-half-stroke"></i><span class="menu-title text-truncate" data-i18n="Colors">Testimonial</span></a>
                </li>
                ...
                <li class="nav-item"><a class="d-flex align-items-center" href="{{ route('admin.alloffer') }}"><i class="fa-solid fa-tags"></i><span class="menu-title text-truncate" data-i18n="Typography">Offers</span></a>
                </li>
            </ul>
        </div>
    </div>
