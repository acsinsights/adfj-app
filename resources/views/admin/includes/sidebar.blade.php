                ...
                <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html">
                    ...
                    alt="AdFj Studios" style="margin-right: 70px;"> --}}
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 774.18 259.41"
                            style="enable-background:new 0 0 774.18 259.41;height: 40px;" xml:space="preserve">
                            <style type="text/css">
                                .st0 {
                                    fill: #2EBBC4;
                                }
                            ...
                            <g>
                                <g>
                                    <path class="st0"
                                        d="M165.58,112.85c-1.11,1.53-2.01,2.41-2.49,3.48c-16.04,35.44-32.04,70.91-48.06,106.36
                           ...
                           C149.19,4.33,182.18,4.33,215.17,4.33z" />
                                ...
                                <g>
                                   ...
                                   c2.01-0.77,4.14-1.97,6.37-3.58V81.65z" />
                                            <path class="st2"
                                                d="M613.34,144.09V9.36h83.72v27.41H645.3v26.85h46.27v27.22H645.3v53.24H613.34z" />
                                   ...
                                   c-3.53,0-6.72-0.5-9.56-1.5C372.75,252.58,370.01,250.98,367.39,248.8z" />
                                            <path class="st2"
                                                d="M434.35,253.91v-57.04h-24.09v-8.53h57.51v8.53h-24.09v57.04H434.35z" />
                                            <path class="st2"
                                                d="M476.66,188.33h9.33v37.64c0,4.19,0.23,7.16,0.68,8.91c0.45,1.75,1.21,3.27,2.27,4.55
                                   ...
                                   c-4-1.76-7.37-4.35-10.12-7.76c-1.69-2.03-2.88-4.29-3.58-6.8c-0.7-2.5-1.05-6.34-1.05-11.53V188.33z" />
                                            <path class="st2"
                                                d="M572.58,188.33c4.84,0,9.01,0.46,12.49,1.36c3.48,0.91,6.68,2.34,9.59,4.31c4.44,3,7.87,6.85,10.29,11.55
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" navigation-header">
                    <span data-i18n="Posts &amp; Pages">Posts</span><i data-feather="more-horizontal"></i>
                </li>

                <li class="nav-item {{ URL::current() == route('admin.allposts') ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{ route('admin.allposts') }}">
                        <i class="fa-solid fa-table-cells"></i>
                        <span class="menu-title text-truncate" data-i18n="Email">All Posts</span>
                    </a>
                </li>


                <li class=" nav-item {{ URL::current() == route('admin.featuredposts') ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{ route('admin.featuredposts') }}">
                        <i class="fa-solid fa-folder"></i>
                        <span class="menu-title text-truncate" data-i18n="Chat">Featured Posts</span>
                    </a>
                </li>


                <li class="nav-item {{ URL::current() == route('admin.addposts') ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{ route('admin.addposts') }}">
                        <i class="fa-solid fa-plus"></i>
                        <span class="menu-title text-truncate" data-i18n="Todo">Add Posts</span>
                    </a>
                </li>


                <li class=" nav-item {{ URL::current() == route('admin.type') ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{ route('admin.type') }}">
                        <i class="fa-solid fa-plus"></i>
                        <span class="menu-title text-truncate" data-i18n="Calendar">Add Service Type</span>
                    </a>
                </li>
                ...
                <li class=" navigation-header">
                    <span data-i18n="Portfolio">Portfolio</span><i data-feather="more-horizontal"></i>
                </li>


                <li class=" nav-item {{ URL::current() == route('admin.music') ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{ route('admin.music') }}">
                        <i class="fa-solid fa-music"></i>
                        <span class="menu-title text-truncate" data-i18n="Typography">Music</span>
                    </a>
                </li>


                <li class=" nav-item {{ URL::current() == route('admin.video') ? 'active' : '' }}"><a
                        class="d-flex align-items-center" href="{{ route('admin.video') }}"><i
                            class="fa-solid fa-video"></i><span class="menu-title text-truncate"
                            data-i18n="Colors">Video</span></a>
                </li>


                <li class=" nav-item {{ URL::current() == route('admin.graphics') ? 'active' : '' }}"><a
                        class="d-flex align-items-center" href="{{ route('admin.graphics') }}"><i
                            class="fa-regular fa-images"></i><span class="menu-title text-truncate"
                            data-i18n="Feather">Graphics</span></a>
                </li>



                <li class=" navigation-header"><span data-i18n="OUR CLIENTELE">OUR CLIENTELE</span><i
                        data-feather="more-horizontal"></i>
                </li>
                <li class=" nav-item {{ URL::current() == route('admin.our-clientlele') ? 'active' : '' }}"><a
                        class="d-flex align-items-center" href="{{ route('admin.our-clientlele') }}"><i
                            class="fa-solid fa-users"></i><span class="menu-title text-truncate"
                            data-i18n="Typography">Client Logo</span></a>
                </li>
                <li class=" nav-item {{ URL::current() == route('admin.testimonial') ? 'active' : '' }}"><a
                        class="d-flex align-items-center" href="{{ route('admin.testimonial') }}"><i
                            class="fa-solid fa-star-half-stroke"></i><span class="menu-title text-truncate"
                            data-i18n="Colors">Testimonial</span></a>
                </li>



                <li class=" navigation-header"><span data-i18n="OUR CLIENTELE">EXCITING OFFERS</span><i
                        data-feather="more-horizontal"></i>
                </li>
                <li class="nav-item {{ URL::current() == route('admin.alloffer') ? 'active' : '' }}"><a
                        class="d-flex align-items-center" href="{{ route('admin.alloffer') }}"><i
                            class="fa-solid fa-tags"></i><span class="menu-title text-truncate"
                            data-i18n="Typography">Offers</span></a>
                </li>

                <li class=" navigation-header">
                    <span data-i18n="CONTACT_FORMS">Contact</span><i data-feather="more-horizontal"></i>
                </li>
                <li class="nav-item {{ URL::current() == route('contact.entries') ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{ route('contact.entries') }}">
