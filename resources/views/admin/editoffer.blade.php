        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Offer Here</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/admin/updateoffer/{{ $offers->id }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        <label for="" class="title">Offer Name</label>
                                        <input type="text" name="offername" class="form-control m-2"
                                            placeholder="Service Category" value="{{ $offers->offername }}">
                                    ...
                                    <img src="/offerimg/{{ $offers->offerimage }}" name="offerimage" class="img-responsive"
                                        style="max-height: 100px; max-width: 100px;" alt="" srcset="">
                                    <br>
                                    <br>
                                </div>
