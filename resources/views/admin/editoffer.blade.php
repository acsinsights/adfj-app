                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Edit Offer</a>
                                    </li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form"action="/admin/updateoffer/{{ $offers->id }}" method="post"
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" name="offerimage" class="custom-file-input" id="customFile">
