    ...
    <main>
                        ...
                        <div class="col-xl-7 col-lg-6 col-md-7">
                            <div class="slider__content-9">
                                ...
                                <div class="slider__btn-9 mb-85">
                                    <a href="{{ asset('get-started') }}" class="tp-btn-5 tp-link-btn-3">
                                        Get Started
                                        <span>
        ...
        <section class="about__area pt-30 pb-120 p-relative" id="about_page">
            <div class="about__shape">
                <img class="about__shape-3" src="{{ asset('user-assets/img/about/6/shape/about-shape-1.png') }}"
                    alt="" />
                <img class="about__shape-4" src="{{ asset('user-assets/img/about/6/shape/about-shape-2.png') }}"
                    alt="" />
                            ...
                            <div class="about__video-thumb">
                                ...
                                <div class="about__play">
                                    <a href="https://www.youtube.com/watch?v=3dXzH-quoTE"
                                        ...
                                        <img src="{{ asset('user-assets/img/about/6/about-play-icon.png') }}"
                                            alt="" />
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="row flex-row text-center align-items-center justify-content-center">
                                    ...
                                    <div class="col-xxl-2 col-md-6 col-sm-6 col-6">
                                        <div class=" skill1">
                                            <div class="skill__icon-9">
                                                <span>
                                                    <img src="{{ asset('user-assets/img/logo/logic-pro.png') }}"
                                                        alt="" height="55px" />
                                                </span>
                                            </div>
                                    ...
                                    <div class="col-xxl-2 col-md-6 col-sm-6 col-6">
                                        <div class="">
                                            <div class="skill__icon-9">
                                                <span>
                                                    <img src="{{ asset('user-assets/img/logo/pro-tools.png') }}"
                                                        alt="" height="55px" />
                                                </span>
                                            </div>
                                            <div class="skill__content-9">
                                    ...
                                    <div class="col-xxl-2 col-md-6 col-sm-6 col-6">
                                        <div class="">
                                            <div class="skill__icon-9">
                                                <span>
                                                    <img src="{{ asset('user-assets/img/logo/Adobe Ae.png') }}"
                                                        alt="" height="60px" />
                                                </span>
                                            </div>
                                            <div class="skill__content-9">
                            ...
                            <div class="testimonial__slider-active-6 swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="testimonial__item-6 transition-3 mb-75 swiper-slide">
                                        ...
                                        <div class="testimonial__avater-6 d-flex align-items-center">
                                            <div class="testimonial__avater-thumb-6">
                                                <img src="{{ asset('user-assets/img/review/two.png') }}"
                                                    alt="" />
                                            </div>
                                            <div class="testimonial__avater-info-6">
                                                <h3 class="testimonial__avater-title-6">
                                    ...
                                    <div class="testimonial__item-6 transition-3 mb-75 swiper-slide">
                                        ...
                                        <div class="testimonial__avater-6 d-flex align-items-center">
                                            <div class="testimonial__avater-thumb-6">
                                                <img src="{{ asset('user-assets/img/review/three.png') }}"
                                                    alt="" />
                                            </div>
                                            <div class="testimonial__avater-info-6">
                                                <h3 class="testimonial__avater-title-6">
                                    ...
                                    <div class="testimonial__item-6 transition-3 mb-75 swiper-slide">
                                        ...
                                        <div class="testimonial__avater-6 d-flex align-items-center">
                                            <div class="testimonial__avater-thumb-6">
                                                <img src="{{ asset('user-assets//img/review/four.png') }}"
                                                    alt="" />
                                            </div>
                                            <div class="testimonial__avater-info-6">
                                                <h3 class="testimonial__avater-title-6">
        ...
        <section class="mobile-brandarea pb-50 brand__area grey-bg-7">
            <div class="container">
                ...
                <div style="margin: 0 7px 0px -9px;" class=" row d-flex ">
                    <div class="col-lg-2 col-md-6">
                    ...
                    <div style="margin: 0 7px 0px -9px;"  class="col-lg-2 col-md-6">
                        <div  style="gap: 50px" class="d-flex">
                ...
                {{-- <div class="brand__item-wrapper-6  d-flex flex-wrap justify-content-between">
                    ...
                    <div class="brand__item-6 mt--30">
                        <img src="{{ asset('user-assets/img/client/client11.png') }}" alt="" />
                    </div>
                    <div class="brand__item-6 mt-9">
                ...
                <div class="brand__item-wrapper-6 align-centre d-flex flex-wrap justify-content-between">
                    <div class="brand__item-6">
                        <img src="{{ asset('user-assets/img/client/neyma.png') }}" alt="" />
                    </div>
                    <div style="margin-top: -27px" class="brand__item-6">
                        <img src="{{ asset('user-assets/img/client/client10.png') }}" alt="" />
                    </div>
                    <div class="brand__item-6">
                        <img src="{{ asset('user-assets/img/client/tring-creatives.png') }}" alt="" />
                    </div>
                    <div style="margin-top: -44px" class="brand__item-6 mt-15">
                        <img src="{{ asset('user-assets/img/client/client7.png') }}" alt="" />
                    </div>
                    <div class="brand__item-6  mt-15">
                ...
                <div class="brand__item-wrapper-6 align-centre d-flex flex-wrap justify-content-between">
                    ...
                    <div class="brand__item-6">
                        <img src="{{ asset('user-assets/img/client/ludo-kamayi.png') }}" alt="" />
                    </div>
                    <div class="brand__item-6">
                        <img src="{{ asset('user-assets/img/client/radiology-adda.png') }}" alt="" />
                    </div>

                    <div style="margin-top: -1px;" class="brand__item-6 mt-20">
                ...
                <div class="brand__item-wrapper-6 align-centre d-flex flex-wrap justify-content-between">
                    <div style="margin-top: 6px;" class="brand__item-6">
                    ...
                    <div style="margin-top: 18px;" class="brand__item-6 ">
                ...
                <div class="brand__item-wrapper-6 align-centre d-flex flex-wrap justify-content-between">
                    ...
                    <div class="brand__item-6">
                        <img src="{{ asset('user-assets/img/client/peak-music.png') }}" alt="" />
                    </div>
                    <div style="margin-top: -16px;" class="brand__item-6">
                        <img src="{{ asset('user-assets/img/client/client1.png') }}" alt="" />
                    </div>
                    <div class="brand__item-6">
                        <img src="{{ asset('user-assets/img/client/agency9.png') }}" alt="" />
                    </div>
                    <div style="margin-top: -28px;" class="brand__item-6">
                        <img src="{{ asset('user-assets/img/client/client5.png') }}" alt="" />
                    </div>
                                    ...
                                    <div class="contact__list-icon-9">
                                        <span>
                                            ...
                                            <img class="contact-icon-shape"
                                                src="{{ asset('user-assets/img/contact/contact-icon-shape.png') }}"
                                                alt="" />
                                        </span>
                                    </div>
