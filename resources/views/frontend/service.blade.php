                        ...
                        <div class="portfolio__slider-active">
                            <div class="portfolio__item-3 transition-3 wow fadeInUp" data-wow-delay=".3s"
                                ...
                                <a href="https://www.youtube.com/watch?v=HGN8mufDavg">
                                    ...
                                    <div class="portfolio__grid-video">
                                        <a href="https://www.youtube.com/watch?v=HGN8mufDavg" class="portfolio-play-btn popup-video tp-el-video-btn">
                            ...
                            <div class="portfolio__item-3 transition-3 wow fadeInUp" data-wow-delay=".3s"
                                ...
                                <a href="https://petals-india.com/">
                                    <div class="portfolio__thumb-3 w-img"
                                        data-background="{{ asset('user-assets/img/portfolio/3/portfolio-5.jpg') }}"></div>
                            ...
                            <div class="portfolio__item-3 transition-3 wow fadeInUp" data-wow-delay=".3s"
                                ...
                                <a href="https://www.instagram.com/p/Ccos67BIgoK/">
                                    <div class="portfolio__thumb-3 w-img"
                                        data-background="{{ asset('user-assets/img/portfolio/3/portfolio-7.jpg') }}"></div>
                                        <div class="portfolio__grid-video">
                                            <a href="https://www.youtube.com/watch?v=EW4ZYb3mCZk&amp;t=147s" class="portfolio-play-btn popup-video tp-el-video-btn">
                                                <svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M18 11L0 21.3923V0.607696L18 11Z" fill="currentColor"></path>
                                                </svg>
                                            </a>
                            ...
                            <div class="portfolio__item-3 transition-3 wow fadeInUp" data-wow-delay=".3s"
                                ...
                                <a href="https://www.youtube.com/watch?v=_BtGT-maCV0">
                                    <div class="portfolio__thumb-3 w-img"
                                        data-background="{{ asset('user-assets/img/portfolio/3/portfolio-3.jpg') }}"></div>
                                        <div class="portfolio__grid-video">
                                            <a href="https://www.youtube.com/watch?v=_BtGT-maCV0" class="portfolio-play-btn popup-video tp-el-video-btn">
                                                <svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M18 11L0 21.3923V0.607696L18 11Z" fill="currentColor"></path>
                                                </svg>
                                            </a>
                            ...
                            <div class="portfolio__item-3 transition-3 wow fadeInUp" data-wow-delay=".3s"
                                data-wow-duration="1s">
                                <a href="https://youtu.be/SX_T7gK8mpE">
                                    <div class="portfolio__thumb-3 w-img"
                                        data-background="{{ asset('user-assets/img/portfolio/3/portfolio-4.jpg') }}"></div>
                                        <div class="portfolio__grid-video">
                                            <a href="https://www.youtube.com/watch?v=SX_T7gK8mpE" class="portfolio-play-btn popup-video tp-el-video-btn">
                                                <svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M18 11L0 21.3923V0.607696L18 11Z" fill="currentColor"></path>
                                                </svg>
                                            </a>
                            ...
                            <div class="portfolio__item-3 transition-3 wow fadeInUp" data-wow-delay=".3s"
                                ...
                                <a href="https://www.youtube.com/watch?v=IFEvDlO1CKg">
                                    <div class="portfolio__thumb-3 w-img"
                                        data-background="{{ asset('user-assets/img/portfolio/3/portfolio-6.jpg') }}"></div>
                                        <div class="portfolio__grid-video">
                                            <a href="https://www.youtube.com/watch?v=IFEvDlO1CKg" class="portfolio-play-btn popup-video tp-el-video-btn">
                                                <svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M18 11L0 21.3923V0.607696L18 11Z" fill="currentColor"></path>
                                                </svg>
                                            </a>
