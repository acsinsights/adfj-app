                        ...
                        <div class="footer__widget-6 mb-50 footer-col-6-4">
                            ...
                            <div class="footer__widget-content">
                                <div class="footer__info">
                                    <div class="footer__info-item-6 d-flex align-items-start">
                                        ...
                                        <div class="footer__info-text-6">
                                            <a target="https://goo.gl/maps/HQLFWmBQ75PordVB9"
                                                href="https://goo.gl/maps/HQLFWmBQ75PordVB9">Office No. 3, Indraprastha
                                                Complex, Boisar 401501,
                                                MH(IN)</a>
                                        </div>
                                    </div>
                                    <div class="footer__info-item-6 d-flex align-items-start">
                                ...
                                <div class="footer__social-6">
                                    ...
                                    <a href="https://www.youtube.com/@AdFJStudios"><i
...
<script src="{{ asset('user-assets/js/nouislider.js') }}"></script>
...
<script src="{{ asset('user-assets/js/charming.js') }}"></script>
<script src="{{ asset('user-assets/js/hover-reveal.js') }}"></script>
