(function ($) {
    ...
    function tp_settings_append($x) {
		...
		<div class="tp-theme-wrapper">
		   <div class="tp-theme-header text-center">
			  <h4 class="tp-theme-header-title">adfj-studios Theme Settings</h4>
		   </div>
    ...
    if ($("#tp-footer-lang-toggle").length > 0) {
        window.addEventListener("click", function (e) {
            if (
                document
                    .getElementById("tp-footer-lang-toggle")
                    .contains(e.target)
            ) {
    ...
    verticalslider2.on("slideChangeTransitionStart", function (realIndex) {
        if (
            $(".swiper-slide.swiper-slide-active").hasClass(
                "slider__item-12-dark"
            )
        ) {
